...
plottempi<-ggplot(Spotify_Wrapped,aes(x = tempo, fill=category, label=track.name)) +
  geom_histogram() + ggtitle("Different Tempi's")
ggplotly(plottempi)
```
...
### **Chordogram** of "Sunflower, vol 6." by Harry Styles
```{r}
...
### "December", **Fleur's** most listened song in a tempogram
...
****
Here you can see that "December" has a clear beat, which you can see the tempogram you can see a nice yellow line of the beat. The line sits around 100BPM, which is slower than I expected.

### "WHAT'S GOOD", one of **Julie's** songs in a tempogram
...
****
"WHAT'S GOOD" has an evident tempo, as you can see from the yellow line in the tempogram. The parts where there is more yellow at the bottom en top too, the song has an instrument (I think a synthesizer) that creates a kind of grainy noise. The line sits a bit under 120BPM.

### "The Less I Know The Better", one of **Hemke's** songs in a tempogrma
...
****
The onsets of "The Less I Know The Better" begin with a very high peak, but the rest is a lot smaller. It looks similair to the onsets of "WHAT'S GOOD".  
