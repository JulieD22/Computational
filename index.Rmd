...
### (new) Chordogram of "Venus in Furs" by The Velvet Underground, outlier of Hemke's playlist.
...
This is chordogram of "Venus in Furs", one of the outliers of Hemke's playlist. The darkestcolors of the chords are G#min, C#min, Abmaj and Dbmaj. Around the 100 and 200 seconds this changes. Then it is Emaj and Emin. The song ends with a fade out, so this explains the lighter colors. It has a very clear chord progressions.  

### (new) Chrordogram of "Sunflower, vol 6." by Harry Styles
```{r}
...
### (new) Chordogram of  "i love you" by Billie Eillish, one of Fleur's outliers
