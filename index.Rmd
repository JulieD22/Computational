...
ggplot(Fleur,aes(x=valence,y=danceability,size=energy)) + geom_point() +ggtitle("Fleur") + geom_smooth() + expand_limits(x = 0, y = 0)

```

### Hemke
```{r}
ggplot(Hemke,aes(x=valence,y=danceability,size=energy)) + geom_point() +ggtitle("Hemke") + geom_smooth() +expand_limits(x = 0, y = 0)
```

### Julie
```{r}
ggplot(Julie,aes(x=valence,y=danceability,size=energy)) + geom_point() +ggtitle("Julie") + geom_smooth() + expand_limits(x = 0, y = 0)
```


# Three playlist in one plot
